...
two_weekly_active_users AS (

     SELECT
        report_date,
        two_weekly_active_users
     FROM {{ref('google_analytics_two_weekly_active_users')}}

),

four_weekly_active_users AS (

     SELECT
        report_date,
        four_weekly_active_users
     FROM {{ref('google_analytics_four_weekly_active_users')}}
...
SELECT
    ...
    two_weekly_active_users.two_weekly_active_users as two_weekly_active_users,
    four_weekly_active_users.four_weekly_active_users as four_weekly_active_users,
...
FROM daily_active_users
  ...
  LEFT JOIN two_weekly_active_users
    ON two_weekly_active_users.report_date = daily_active_users.report_date
  LEFT JOIN four_weekly_active_users
    ON four_weekly_active_users.report_date = daily_active_users.report_date
